...
# ==============================================================================
# Prompt-Z mainline 16-case sweep using the default B recipe.
#
# Cases:
#   datasets: WTH, ETTm2, ETTm1, ETTh2
#   horizons: 1, 24, 48, 96
#
# Total:
#   16 cases
...
RUN_TAG=${RUN_TAG:-main_B_16cases}
WEIGHT_TAG=${WEIGHT_TAG:-$RUN_TAG}
SELECTED_ONLY=${SELECTED_ONLY:-0}

CASES=${CASES:-"\
WTH.csv:1:12 WTH.csv:24:12 WTH.csv:48:12 WTH.csv:96:12 \
ETTm2.csv:1:7 ETTm2.csv:24:7 ETTm2.csv:48:7 ETTm2.csv:96:7 \
ETTm1.csv:1:7 ETTm1.csv:24:7 ETTm1.csv:48:7 ETTm1.csv:96:7 \
ETTh2.csv:1:7 ETTh2.csv:24:7 ETTh2.csv:48:7 ETTh2.csv:96:7"}
...
echo "================================================================="
echo " Prompt-Z Mainline 16 Cases (B Recipe)"
echo "================================================================="
